...
def fine_tuning(args):
    ...
    training_args = TrainingArguments(
        ...
        fp16=False,
        report_to="none",
        deepspeed=os.path.join(os.path.dirname(SCRIPT_DIR), "omni_speech", "train", "ds_config.json"),
    )
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("training_curve_loss_5.png")
    print("Graphic saved")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--manifest-path", type=str, default="manifests_cv/manifest_1.jsonl")
